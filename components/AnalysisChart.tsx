...
const AnalysisChart: React.FC<AnalysisChartProps> = ({ result }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="h-72 md:h-80 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-2xl p-4 flex flex-col shadow-lg shadow-slate-200/40 dark:shadow-none relative overflow-hidden group hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-xl hover:scale-[1.01] transition-all duration-300">
        {/* Header */}
        <div className="flex items-center justify-center mb-1 shrink-0 z-10 relative">
          ...
          <InfoTooltip content="The estimated likelihood (0-100%) that the analyzed content was generated by Artificial Intelligence. A higher percentage suggests synthetic origin." />
        </div>
      ...
      <div className="h-72 md:h-80 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-2xl p-4 flex flex-col shadow-lg shadow-slate-200/40 dark:shadow-none relative overflow-hidden group hover:border-indigo-400 dark:hover:border-indigo-500 hover:shadow-xl hover:scale-[1.01] transition-all duration-300">
        <div className="flex items-center justify-center mb-1 shrink-0 z-10 relative">
          ...
          <InfoTooltip content="Visualizes the distinct characteristics that influenced the verdict. Points further from the center indicate a stronger impact on the final decision, whether supporting a Human or AI classification." />
        </div>
